/**
 * Declare GEOCODE global and namespace utility function
 * Used to create namespaces for the module pattern
 */
var GEOCODE = GEOCODE || {};

/**
 * Object to assets such as images
 */
GEOCODE.namespace("assets");
GEOCODE.assets = (function ($) {
    return {
        images: {
            bike:           '/images/bike32.png',
            pickup_marker:  '/images/green_MarkerA.png',
            dropoff_marker: '/images/blue_MarkerB.png'
        },
        radar: {}
    };
}(jQuery));

GEOCODE.namespace = function (namespaceStr) {
 ...
 */
GEOCODE.namespace("model");
GEOCODE.model = (function ($) {
    return {
        courier: {
            AVAILABLE: "available",
 ...
 * Global event bus
 */
GEOCODE.namespace("events");
GEOCODE.events = (function (app, $) {
 ...
 */
GEOCODE.namespace("geolocation");
GEOCODE.geolocation = (function (app, $) {
    var geolocation,
    geolocationOptions = {
...
GEOCODE.namespace("map");
GEOCODE.map = (function (app, $) {
    ...
    function setCourierLocation(position) {
        ...
        courierLocationMarker = new g.Marker({
            map: map,
            title: text,
            icon: images.bike, // see assets namespace
    ...
    function setPickupLocation(position) {
        ...
        pickupLocationMarker = new g.Marker({
          ...
          title: text,
          icon: images.pickup_marker // see assets namespace
        });
    ...
    function setDropoffLocation(position) {
        ...
        dropoffLocationMarker = new g.Marker({
            ...
            title: text,
            icon: images.dropoff_marker // see assets namespace
        });
...
GEOCODE.namespace("workflow");
GEOCODE.workflow = (function (app, $) {
    var ajax = app.ajax,
    courier = app.courier,
    map = app.map,
    route = app.route,
...
GEOCODE.namespace("workflow.deliveryOfferState");
GEOCODE.workflow.deliveryOfferState = function (app, $) {
    var ajax = app.ajax,
    courier = app.courier,
 ...
 */
GEOCODE.namespace("route");
GEOCODE.route = function (newFrom, newTo) {
    var from = newFrom,
    to = newTo;
